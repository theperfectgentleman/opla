...
class ProjectDirectoryItem(Base):
    __tablename__ = "project_directory_items"
    ...
    project = relationship("Project", backref="directory_items")
    creator = relationship("User")

    __table_args__ = (
        Index("ix_project_directory_items_project_sku", "project_id", "sku_code", unique=True),
    )
