    ...
    return (
        <div className="flex text-sm h-screen bg-[hsl(var(--background))] text-[hsl(var(--text-primary))] overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <nav className="space-y-1">
                        {!isSidebarCollapsed && currentOrg && (
                            <div className="mb-4 rounded-md border border-[hsl(var(--border))] bg-[hsl(var(--surface-elevated))] px-4 py-3">
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                <header className={`relative z-40 h-[60px] border-b border-slate-200 flex items-center justify-between bg-[hsl(var(--surface))]/70 backdrop-blur-md gap-3 ${alignRightRail ? 'pl-4 md:pl-8 pr-0' : 'px-4 md:px-8'}`}>
                    <div className="flex items-center bg-slate-100 rounded-md px-4 h-9 w-72 sm:w-80 md:w-96 lg:w-[26rem] border border-transparent focus-within:border-slate-300 focus-within:bg-white focus-within:ring-2 focus-within:ring-slate-200 transition-all shrink-0">
                        ...
                        <div className={`${alignRightRail ? 'h-full w-80 border-l border-[hsl(var(--border))] px-4 md:px-6 flex items-center justify-end' : 'pl-3 md:pl-4 border-l border-[hsl(var(--border))]'} `}>
                            <div ref={profileMenuRef} className="relative">
                                ...
                                >
                                    ...
                                    <div className="w-10 h-10 bg-gradient-to-br from-[hsl(var(--accent-1))] to-[hsl(var(--accent-2))] rounded-md shadow-lg"></div>
                                    <ChevronDown className={`w-4 h-4 text-[hsl(var(--text-tertiary))] transition-transform ${isProfileMenuOpen ? 'rotate-180' : ''}`} />
                                </button>

                                {isProfileMenuOpen && (
                                    <div className="absolute right-0 mt-3 w-[22rem] bg-[hsl(var(--surface))] border border-[hsl(var(--border))] rounded-md shadow-xl p-4 z-[60]">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-[hsl(var(--surface-elevated))] border border-[hsl(var(--border))] rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[hsl(var(--primary))] transition-all cursor-pointer"
                                            >
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center px-3 py-2.5 rounded-md border border-[hsl(var(--border))] bg-[hsl(var(--surface-elevated))] hover:bg-[hsl(var(--surface))] text-[hsl(var(--text-primary))] font-semibold transition-all mb-3"
                                        >
                                            + Create Organization
                                        </button>
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center space-x-3 px-3 py-2 rounded-md hover:bg-[hsl(var(--error))]/10 text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--error))] transition-all"
                                        >
