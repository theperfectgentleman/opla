...
const FormBuilder: React.FC = () => {
    ...
    const getTypeIconStyle = (type: FieldType) => {
        switch (type) {
            // Standard Inputs (Blue/Sky/Indigo/Violet/Slate shades)
            case 'input_text':
    ...
    const getSolidTypeIconStyle = (type: FieldType) => {
        switch (type) {
            ...
            case 'textarea':
                return 'bg-slate-50 text-slate-600 dark:bg-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-800';
