...
# Original Return statement is on line 625 (index 624).
# In powershell rewrite, our new lines might have replaced it incorrectly,
# Wait! Since I ran rewrite.ps1, the file is currently corrupted!
# I need to restore from git and then run this script!
